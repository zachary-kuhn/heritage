...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14034 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14034 = (function (val,box,meta14035){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14034.cljs$lang$type = true;
cljs.core.async.impl.channels.t14034.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14034";
cljs.core.async.impl.channels.t14034.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/t14034");
});
cljs.core.async.impl.channels.t14034.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14034.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14036){var self__ = this;
var _14036__$1 = this;return self__.meta14035;
});
cljs.core.async.impl.channels.t14034.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14036,meta14035__$1){var self__ = this;
var _14036__$1 = this;return (new cljs.core.async.impl.channels.t14034(self__.val,self__.box,meta14035__$1));
});
cljs.core.async.impl.channels.__GT_t14034 = (function __GT_t14034(val__$1,box__$1,meta14035){return (new cljs.core.async.impl.channels.t14034(val__$1,box__$1,meta14035));
});
}
return (new cljs.core.async.impl.channels.t14034(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14037 = self__.takes.pop();if((taker_14037 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14037))
{var take_cb_14038 = cljs.core.async.impl.protocols.commit.call(null,taker_14037);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14038,taker_14037,this$__$1){
return (function (){return take_cb_14038.call(null,null);
});})(take_cb_14038,taker_14037,this$__$1))
);
} else
{}
{
