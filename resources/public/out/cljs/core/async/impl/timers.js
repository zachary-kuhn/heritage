...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_13935 = (0);while(true){
if((i_13935 < arr.length))
{(arr[i_13935] = null);
{
...
{var i_13942 = (self__.level + (1));while(true){
if((i_13942 <= (new_level + (1))))
{(update[i_13942] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13944 = (0);while(true){
if((i_13944 <= self__.level))
{var links_13945 = (update[i_13944]).forward;if(((links_13945[i_13944]) === x__$1))
{(links_13945[i_13944] = (x__$1.forward[i_13944]));
{
var G__13946 = (i_13944 + (1));
i_13944 = G__13946;
continue;
}
} else
{{
var G__13947 = (i_13944 + (1));
i_13944 = G__13947;
continue;
}
}
