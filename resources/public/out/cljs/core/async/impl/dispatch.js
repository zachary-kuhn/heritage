...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14028 = (0);while(true){
var m_14029 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14029 == null))
{} else
{m_14029.call(null);
if((count_14028 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14030 = (count_14028 + (1));
count_14028 = G__14030;
continue;
}
} else
{}
